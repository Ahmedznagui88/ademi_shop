<x-layout>
    <div class="container">
        <div class="row justify-content-center text-dark row-registerlogin">
            <div class="col-12 col-md-6 bg-logo d-flex align-items-center" id="bg-register-login">
                <div class="divimg" id="">
            ...
            <div class="col-12 col-md-6 divlogin-register">
